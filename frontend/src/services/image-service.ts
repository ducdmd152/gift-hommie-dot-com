...
export default {
  ...
  async upload(image: File) {
    const api = "https://web-image-storage.p.rapidapi.com/upload";
    const formData = new FormData();
    formData.append("image", image);
    formData.append("deleteCode", "example_value");
    let res = this.getDefaultProductAvatarURL();
    await axios
      .post(api, formData, {
        headers: {
          "X-RapidAPI-Key":
            "40b9e473c7msh65447c7af0d8437p16b742jsn83ff20b73ea1",
      ...
      .catch((err) => {
        res = this.getDefaultProductAvatarURL();
      });
    return res;
  },
};
